...
@foreach($tokens as $token)
    ...
    @endforeach
    <?php $token_num=$token->morning_meal_quantity;
    while ($token_num!=0){
        echo "
                        <h5 style='text-align: center'>".$num."."."Morning Meal"."(".$token->date.") Sheikh Rehena Hall, BSMRSTU.  Student ID:".$info->student_id."</h5>
    ...
    $token_num=$token->launch_meal_quantity;
    while ($token_num!=0){
        echo "
                            <h5 style='text-align: center'>".$num."."."Launch Meal"."(".$token->date.") Sheikh Rehena Hall, BSMRSTU.  Student ID:".$info->student_id."</h5>
    ...
    $token_num=$token->dinner_meal_quantity;
    while ($token_num!=0){
        echo "
                            <h5 style='text-align: center'>".$num."."."Dinner Meal"."(".$token->date.") Sheikh Rehena Hall, BSMRSTU.  Student ID:".$info->student_id."</h5>
