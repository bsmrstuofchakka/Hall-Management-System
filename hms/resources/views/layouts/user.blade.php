            ...
            <div style="background-color: #3e6562;" class="page-sidebar-wrapper">
                ...
                <div style="background-color: #3e6562;" class="page-sidebar navbar-collapse collapse" >
                   ...
                   <?php      } ?>
                        ...
                        $members = array('direct_token_list','set_token_date','token_list','update_meal_cost','turn_on_token_sell','turn_off_token_sell');
                        ?>
                        <li class="nav-item {{ in_array(Request::path(), $members) ? 'active' : '' }}">
                            <a  href="javascript:;" class="nav-link nav-toggle">
                                <i  class="fa fa-cog"></i>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item {{ Request::path() == 'direct_token_list' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('direct_token_list') }}" class="nav-link ">
                                ...
                                ?>
                                @if($token_option->status==0)
                                    <li class="nav-item {{ Request::path() == 'turn_on_token_sell' ? 'active' : '' }}">
                                        <a  href="{{ URL::to('turn_on_token_sell') }}" id="turnOn" onclick="turnOn()" class="nav-link ">
                                            <span class="title">Turn On Token Sell</span>
                                        </a>
                                    </li>
                                @else
                                    <li class="nav-item {{ Request::path() == 'turn_off_token_sell' ? 'active' : '' }}">
                                        <a  href="{{ URL::to('turn_off_token_sell') }}" id="turnOff" onclick="turnOff()" class="nav-link ">
